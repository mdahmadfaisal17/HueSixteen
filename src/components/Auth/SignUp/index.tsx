...
const SignUp = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            toast.error("Email/password sign up is disabled. Please use a trusted provider.");
        } catch {
                            ...
                            <div className="relative shadow-lg mx-auto max-w-32 overflow-hidden rounded-lg bg-white px-8 py-14 text-center sm:px-12 md:px-16">
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className="mb-5 text-left">
                                        <input
                                            ...
                                            className={`w-full rounded-full border px-5 py-3 outline-none transition border-stroke focus:border-dark_black focus:border-opacity-50`}
                                        />
                                    ...
                                    <div className="mb-5 text-left">
                                        <input
                                            ...
                                            onChange={handleChange}
                                            className={`w-full rounded-full border px-5 py-3 outline-none transition focus:border-dark_black border-stroke focus:border-opacity-50`}
                                        />
                                ...
                                <div className="flex flex-col max-w-xs mx-auto gap-2">
                                    <p className="text-dark_black text-opacity-70 dark:text-opacity-50">
                                        ...
                                        <Link href="/privacy-policy" className="text-dark_black">
                                            Privacy
                                        </Link>{" "}
                                        and{" "}
                                        <Link href="/privacy-policy" className="text-dark_black">
                                    ...
                                    <p className="text-dark_black text-opacity-70">
                                        Already have an account?
                                        <Link href="/signin" className="text-dark_black">
                                            {" "}Sign In
                                        </Link>
                                    </p>
                                </div>
