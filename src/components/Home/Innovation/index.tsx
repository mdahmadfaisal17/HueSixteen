                    ...
                    <div className="flex flex-col gap-12">
                        ...
                        <motion.div {...bottomAnimation(3)} className="flex flex-col gap-4 xl:flex xl:flex-row bg-dark_black items-center justify-between dark:bg-white dark:bg-opacity-5 py-8 px-7 sm:px-12 rounded-3xl w-full">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 items-center w-full sm:w-auto">
                                <Link href="/contact" className='group w-[220px] sm:w-auto text-dark_black font-medium bg-white rounded-full flex items-center justify-between py-2 pl-5 pr-2 border border-white dark:border-opacity-50 transition-colors duration-500 ease-out hover:bg-purple_blue hover:text-white hover:border-transparent'>
                                ...
                                <Link href="/#work" className='group w-[220px] sm:w-auto border border-white dark:border-opacity-50 text-white font-medium bg-transparent rounded-full flex items-center justify-between py-2 pl-5 pr-2 transition-colors duration-500 ease-out hover:bg-purple_blue hover:text-white hover:border-transparent'>
